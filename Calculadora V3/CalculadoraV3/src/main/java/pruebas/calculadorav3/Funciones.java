...
public class Funciones {
    ...
    public String evaluarOperacion(String operacion) {
        try {
            ...
            operacion = resolverPorcentaje(operacion);
    ...
    public String resolverPorcentaje(String operacion) {
        ...
        while (matcher.find()) {
            ...
            operacion = operacion.replace(subExpr, String.format("%.2f", resultado));
            matcher = pattern.matcher(operacion);
        }
        return operacion;
    }
    
    public String resolverMultiplicacionDivision(String operacion) {
    ...
    public String resolverSumaResta(String operacion) {
    ...
    public boolean operacionIncompleta(String operacion) {
        String operandos = "^[+\\-x/%]$";
        if (!operacion.matches(operandos)) {
            return true;   
        }
        return false;
    }
